...
kubectl run test-connectivity --rm -it --restart=Never \
  ...
  -- curl -v https://license.smallest.ai
```
...
3. Connects to `license.smallest.ai`
...
INFO: Connecting to license.smallest.ai
...
<AccordionGroup>
  ...
  <Accordion title="Network Connectivity" icon="network-wired">
    ...
    **Solution**:
    - Test connectivity: `curl https://license.smallest.ai`
